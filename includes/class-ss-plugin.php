...
class Plugin
{
    ...
    /**
     * Instance of EditingHooks class.
     * @var EditingHooks
     */
    protected $editing_hooks = null;
    ...
    public static function instance()
    {
        if (null === self::$instance) {
            ...
            self::$instance->editing_hooks = new EditingHooks(self::$instance);
            ...
            add_action('plugins_loaded',function(){
                if (get_option('simply-static-publish-state')=='needs') {
                    add_action('admin_notices',function()  {
                        $adminUrl = admin_url('admin.php?page=simply-static');
                        $message = "The site has been changed and needs to be published.  <a href='$adminUrl'>Click here to publish.</a>";
                        ?>
    ...
    private function includes()
    {
        ...
        require_once $path . 'includes/class-ss-editing-hooks.php';
    ...
    {
        // TODO: Track changes in database, see ilab-publish-tool
        update_option('simply-static-publish-state','needs');
    }
}
